						...
						<div class="card-body">
							<div class="category" align="center">
								<a class="btn btn-primary float-end"
									href="./menu_select_all?category=">전체</a> <a
									class="btn btn-primary float-end"
									href="./it_event_list?category=EVENT_IT_EVENT">IT 이벤트</a> <a
									class="btn btn-primary float-end"
							...
							<table class="table table-hover table-striped text-center"
								...
								<tbody>
									<c:forEach varStatus="status" var="board" items="${eventList}">
										<tr>
											<th>${board.bNo}</th>
						...
						<nav>
							<ul class="pagination justify-content-center">
								...
								<c:choose>
									<c:when test="${startPage <= 1}">
										<li class="page-item disabled"><a class="page-link"
											href="#" aria-label="Previous-PageBlock"> <span
												aria-hidden="true">&laquo;</span> <span class="sr-only">페이지
													이전블럭 이동</span>
										</a></li>
									</c:when>
									<c:otherwise>
										<li class="page-item"><a class="page-link"
											href="./BoardList.do?page=${startPage-1}"
											aria-label="Previous-PageBlock"> <span aria-hidden="true">&laquo;</span>
								...
								<c:choose>
									<c:when test="${page <= 1}">
										<li class="page-item disabled"><a class="page-link"
											href="#" aria-label="Previous-Page"> <span
												aria-hidden="true">&lt;</span> <span class="sr-only">이전
													페이지 한칸 이동</span>
										</a></li>
									</c:when>
									<c:otherwise>
										<li class="page-item"><a class="page-link"
											href="./BoardList.do?page=${page-1}"
											aria-label="Previous-Page"> <span aria-hidden="true">&lt;</span>
								...
								<c:forEach var="pageNumber" begin="${startPage}"
									...
									<c:choose>
										...
										<c:otherwise>
											<li class="page-item"><a class="page-link"
												href="./BoardList.do?page=${pageNumber}">${pageNumber}</a></li>
										</c:otherwise>
									</c:choose>
								</c:forEach>
								...
								<c:choose>
									...
									<c:otherwise>
										<li class="page-item"><a class="page-link"
											href="./BoardList.do?page=${page+1}" aria-label="Next"> <span
												aria-hidden="true">&gt;</span> <span class="sr-only">다음
													페이지 한칸 이동</span>
										</a></li>
									</c:otherwise>
								</c:choose>
								...
								<c:choose>
									...
									<c:otherwise>
										<li class="page-item"><a class="page-link"
											href="./BoardList.do?page=${endPage+1}" aria-label="Next">
												<span aria-hidden="true">&raquo;</span> <span
												class="sr-only">페이지 다음블럭 이동</span>
										</a></li>
									</c:otherwise>
								</c:choose>
						...
						<section id="search" class="mb-3 bg-light">
							<div class="container">
								<div class="form-row justify-content-center">
									<form action="./BoardSearch.do" method="post" name="search"
										...
										<fieldset>
											<div class="input-group mx-auto">
												...
												<button class="btn btn-outline-danger input-group-append"
													type="submit">
