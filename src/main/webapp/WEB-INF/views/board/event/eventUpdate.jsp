		...
		<div class="row justify-content-center">
		    <div class="col-md-8 mt-3 mb-3">
		        ...
		        <h2 class="text-center mt-4 mb-4"><strong>이벤트 게시판</strong></h2>
			    	...
			    	<div class="card-body">
				        <form action="./eventUpdate?&bno=${boardList.bno}" name="EventUpdateForm" id="EventUpdateForm" method="post" enctype="multipart/form-data">
				          <table class="table table-striped">
				            ...
				            <tr>
				                <th>제목</th>
				                <td><input type="text"  class="form-control" name="title" id="title" value="${boardList.title}"></td>
				            </tr>
 				             <tr>
				                <td>내용</td>
				                <td><textarea rows="10" cols="50" name="contents" id="contents" class="form-control">${boardList.contents}</textarea></td>
				            </tr>
				            <!--<tr>
				            	<td>첨부파일</td>
