		...
		<div class="card">
		  ...
		  <div class="card-body">
			<div id="BtnCategory" class="category" align="center">
			  ...
			  <a class="btn btn-warning float-end" data-value="EVENT_IT_EVENT"
			  href="<c:url value='./list'/>?&category=EVENT_IT_EVENT&type=${pagination.criteria.type}&keyword=${pagination.criteria.keyword}">IT 이벤트</a>
			  <a class="btn btn-warning float-end" data-value="EVENT_MARKETING"
			  href="<c:url value='./list'/>?&category=EVENT_MARKETING&type=${pagination.criteria.type}&keyword=${pagination.criteria.keyword}">마케팅</a>
			</div>
