		...
		<div class="card">
		  ...
		  <div class="card-body">
			<div id="BtnCategory" class="category" align="center">
			  <a class="btn btn-primary float-end all-category-btn" data-value="" href="<c:url value='./list'/>?category=&type=${pagination.criteria.type}&keyword=${pagination.criteria.keyword}">전체</a>
			  <a class="btn btn-warning float-end" data-value="COMMUNITY_LIFE" href="<c:url value='./list'/>?&category=COMMUNITY_LIFE&type=${pagination.criteria.type}&keyword=${pagination.criteria.keyword}">사는 얘기</a>
			  <a class="btn btn-warning float-end" data-value="COMMUNITY_GROUP" href="<c:url value='./list'/>?&category=COMMUNITY_GROUP&type=${pagination.criteria.type}&keyword=${pagination.criteria.keyword}">모임&스터디</a>
			</div>
				  ...
				  <c:choose>
				    <c:when test="${fn:length(board.title)>15}">
				      <td title="${board.title}">
				        <a href="./selectdetail_view${pagination.getListLink(pagination.criteria.page)}&bno=${board.bno}">
