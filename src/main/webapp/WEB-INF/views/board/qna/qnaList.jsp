			...
			<div class="row justify-content-center">
				<div class="col-8">
					<div class="card">
						...
						<div class="card-body">
<!-- 							<div align="center">
								<button type="button" class="btn btn-primary float-end" name="kind" value="tech">기술</button>
								<button type="button" class="btn btn-primary float-end" name="kind" value="career">커리어</button>
								<button type="button" class="btn btn-primary float-end" name="kind" value="qna-etc">기타</button>
								<button type="button" class="btn btn-primary float-end" name="kind" value="all">전체</button>								
							</div> -->
